...
# Install the Agent
ADD https://1317-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.10.0.git.84.ae9225e-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.10.0.git.84.ae9225e-1_amd64.deb && rm /datadog-agent_5.10.0.git.84.ae9225e-1_amd64.deb
